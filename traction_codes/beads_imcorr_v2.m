...
function [xv,yv,dxv,dyv]=beads_imcorr_v2(im1, im2); % start size of block is specified inside the script


blocksize_start	    =  64;		% Resolution at the starting level; 32
resolution       	=  64;		% Resolution at the final level; Changed from 8 to 16
min_pixval			=  1000;		% Smallest pixel value for a bead %% changed from 50
