...
function [xv,yv,dxv,dyv]=Sam_beads_imcorr_v2_stretcher(im1, im2,min_pixval)%,blocksize_start, resolution, min_pixval); % start size of block is specified inside the script

blocksize_start	    =  32;		% Resolution at the starting level; 32
resolution       	=  32;		% Resolution at the final level; Changed from 8 to 16
min_pixval			= 1100;		% Smallest pixel value for a bead 
