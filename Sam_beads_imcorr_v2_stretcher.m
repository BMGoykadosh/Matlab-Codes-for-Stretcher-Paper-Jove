...
function [xv,yv,dxv,dyv]=Sam_beads_imcorr_v2_stretcher(im1, im2)%,min_pixval, blocksize_start, resolution)%,blocksize_start, resolution, min_pixval); % start size of block is specified inside the script
